...
# Data
    ...
    ap.add_argument('--test_cell', type=str, default='') # Assume it's a string 'cell0,cell4,cell3'
...
################### TRAINING #######################
    ...
    for e in range(args.epochs):
        ...
        print("Epoch %u:\t Time: %0.2f \t(per epoch: %0.2f)"%(e, time.time()-t0, (time.time()-t0)/(e+1)))#, trainlog_sorted_by_losstype, vallog_sorted_by_losstype)
    
    # SAVE
        if e%(args.save_model_freq)==0 or e==args.epochs-1: 
            print("SAVING MODEL")
